...
def setup(app):
    ...
    app.add_config_value('is_a_released_version', is_a_released_version, 'env')
...
project = 'The Stdlib library'
copyright = '1999-2024, Inria, CNRS and contributors'
author = 'The Stdlib Development Team'
...
html_context = {
    ...
    'versions': [
        ...
        ("9.2", "https://rocq-prover.org/doc/v9.2/refman-stdlib/"),
        ("9.1", "https://rocq-prover.org/doc/v9.1/refman-stdlib/"),
