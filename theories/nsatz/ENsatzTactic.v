...
(*
 ...
 Examples: see test-suite/success/ENsatz.v and test-suite/success/ENsatz2.v
  ...
  Ltac ensatz_solve p2 lp2 n fv vs info :=
    ...
    NsatzTactic.nsatz_call 1%N info 0%Z p2 lp2
      ltac:(fun c r lq lci =>
              ...
              let H1 := fresh "H" in
              intros H1;
              cbn in H1;revert H1;clear;nsatz
           ).
