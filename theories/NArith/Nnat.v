...
Abbreviation nat_of_N_inj := N2Nat.inj (only parsing).
Abbreviation N_of_nat_of_N := N2Nat.id (only parsing).
Abbreviation nat_of_Ndouble := N2Nat.inj_double (only parsing).
Abbreviation nat_of_Ndouble_plus_one := N2Nat.inj_succ_double (only parsing).
Abbreviation nat_of_Nsucc := N2Nat.inj_succ (only parsing).
Abbreviation nat_of_Nplus := N2Nat.inj_add (only parsing).
Abbreviation nat_of_Nmult := N2Nat.inj_mul (only parsing).
Abbreviation nat_of_Nminus := N2Nat.inj_sub (only parsing).
Abbreviation nat_of_Npred := N2Nat.inj_pred (only parsing).
Abbreviation nat_of_Ndiv2 := N2Nat.inj_div2 (only parsing).
Abbreviation nat_of_Ncompare := N2Nat.inj_compare (only parsing).
Abbreviation nat_of_Ndiv := N2Nat.inj_div (only parsing).
Abbreviation nat_of_Nmod := N2Nat.inj_mod (only parsing).
Abbreviation nat_of_Npow := N2Nat.inj_pow (only parsing).
Abbreviation nat_of_Nmax := N2Nat.inj_max (only parsing).
Abbreviation nat_of_Nmin := N2Nat.inj_min (only parsing).

Abbreviation nat_of_N_of_nat := Nat2N.id (only parsing).
Abbreviation N_of_nat_inj := Nat2N.inj (only parsing).
Abbreviation N_of_double := Nat2N.inj_double (only parsing).
Abbreviation N_of_double_plus_one := Nat2N.inj_succ_double (only parsing).
Abbreviation N_of_S := Nat2N.inj_succ (only parsing).
Abbreviation N_of_pred := Nat2N.inj_pred (only parsing).
Abbreviation N_of_plus := Nat2N.inj_add (only parsing).
Abbreviation N_of_minus := Nat2N.inj_sub (only parsing).
Abbreviation N_of_mult := Nat2N.inj_mul (only parsing).
Abbreviation N_of_div2 := Nat2N.inj_div2 (only parsing).
Abbreviation N_of_nat_compare := Nat2N.inj_compare (only parsing).
Abbreviation N_of_nat_div := Nat2N.inj_div (only parsing).
Abbreviation N_of_nat_mod := Nat2N.inj_mod (only parsing).
Abbreviation N_of_nat_pow := Nat2N.inj_pow (only parsing).
Abbreviation N_of_min := Nat2N.inj_min (only parsing).
Abbreviation N_of_max := Nat2N.inj_max (only parsing).
